...
| **D-03** | Estructura real del archivo Excel | El importador se diseña contra un formato concreto. | Dejar un archivo de ejemplo (aunque sea con cifras alteradas) en `docs/ejemplos/` |
